...
% The colors of remote objects seem to be present to sensory consciousness. And as \citet[256]{McDowell:2008fk} has had occasion to observe, one can only be presented with what one has a capacity to receive. But what could \emph{receive} mean here if what's received remains remote? 

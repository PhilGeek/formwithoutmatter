...
% He makes a related claim in his discussion of the generation of the hues. Specifically, when discussing the generation of the hues from the ratio that results from the superposition of black and white, Aristotle observes that:
% \begin{quote}
...
% \end{quote}
% If Aristotle is willing to entertain this claim (and it is not for this reason that the account of the generation of the hues in terms of superposition is rejected in favor of the account in terms of mixture), then it is open to Aristotle to accept a corresponding claim:

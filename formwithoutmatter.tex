...
In \emph{De Anima}, Aristotle defines the transparent in terms of the manner of its visibility:
\begin{quote}
...
\end{quote}
The limit of a body is its external surface, a bulgy two-dimensional particular, in \citet[]{Sellars:1956xp} apt phrase. Color lies at the limit of the body, but it is not the limit of the body. Does the consideration that tells against color being the limit of the body---that the same nature which exhibits color outside also exists within---tell equally against color being the limit of the transparent? Not obviously. Opaque solids are perceptually impenetrable, and their perceptual impenetrability defines a visual boundary through which nothing further can appear. This visual boundary corresponds with the limit of the body. But is this really inconsistent with claiming that the same nature which exhibits color outside also exists within? Only if we ignore Aristotle's reminder at the opening of \emph{De Sensu} \textsc{iii} 439\( ^{a} \)13--14 that ``each of these terms is used in two senses: as actual or potential.'' When the perceptually impenetrable is actually resisting sight a visual boundary is determined at the limit of the opaque body. But that a portion of the interior of such a body offers no such visual resistance in being occluded from view does not make it any less perceptually impenetrable.
...
Aristotle defines color as the power to move what is actually transparent (\emph{De Anima} \textsc{ii}.7 418\( ^{b} \)29--31; \textsc{ii}.7 419\( ^{a} \)10--12).

First, as Hicks observes

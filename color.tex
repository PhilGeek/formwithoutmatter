...
Theophrastus (\emph{De Sensibus} 79; DK 68\textsc{a}135) alludes to a pre-Democritean tradition according to which white and black are the primary colors, the colors in terms of which all other colors are to be explained. Arguably, Parmenides and Empedocles belong to this pre-Democritean tradition (though the latter is controversial).

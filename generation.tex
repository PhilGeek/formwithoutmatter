...
Earlier we registered a disanalogy between the juxtaposition model on the one hand and pointillism and color halftone printing on the other. While the latter involves parts to small to be seen from a certain distance, the former involves parts too small to be seen at any distance. The partiality of perception is manifest in viewing the color of the depicted scene in a pointillist painting, just as it would be if the juxtaposition model were false.

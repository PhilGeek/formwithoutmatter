...
\begin{frame}
	\begin{center}
		\includegraphics[height=8cm]{../../graphics/redsun.jpg}
	\end{center}
\end{frame}
...
\begin{frame}
	\begin{center}
		\includegraphics[height=8cm]{../../graphics/blackriver.jpg}
	\end{center}
\end{frame}
...
\begin{frame}[t]\frametitle{Juxtaposition}
	\begin{center}
		\includegraphics[height=8cm]{../../graphics/brickwall.jpg}
	\end{center}
\end{frame}
...
In a passage self-consciously recounting the older view, Plato describes  (in number 10 on your handout) the cycle of elemental transformation. % thus:
% \begin{quote}

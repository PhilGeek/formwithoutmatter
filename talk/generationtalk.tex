...
% That Aristotle's account of chromatic composition should parallel in this way his account of elemental composition is no accident. Rather, it is an expression of an explanatory commitment. Just as a proportion of so-called elements in a mixture can explain the sensible qualities of a compound, so a proportion of light and dark in a mixture explains the color of a remote bounded particular. This is not a claim about the ordering of the colors, it is rather a claim about the explanatory determinants of the chromatic hues.
